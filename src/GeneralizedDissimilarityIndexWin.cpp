 ...
 */
 ...
 /*!
	\file GeneralizedDissimilarityIndexWin.cpp
...
GeneralizedDissimilarityIndexWin::GeneralizedDissimilarityIndexWin(PluginParameters* pp)
: SpatialIndexWin(pp)
{
	...
	m_spatialIndex = new GeneralizedDissimilarityIndex();
	m_helpPath = "TerraSegreg/GeneralizedDissimilarityIndex.html";
} 

GeneralizedDissimilarityIndexWin::~GeneralizedDissimilarityIndexWin()
{}

void GeneralizedDissimilarityIndexWin::verifyPushButton_clicked()
{
...
bool GeneralizedDissimilarityIndexWin::configureSpatialIndex()
{
	return true;
}

void GeneralizedDissimilarityIndexWin::update(TeSTElementSet* objSet)
{
	...
	QMessageBox::information(this, tr("Information"), tr("Generalized Spatial Dissimilarity Index calculated with successful."));
}
